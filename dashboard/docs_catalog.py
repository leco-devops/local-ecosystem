...
DOC_MODULES = [
    ...
    {
        "id": "ai-onboarding-plan",
        "title": "AI-assisted onboarding — design",
        "category": "Architecture",
        "rel_path": "docs/AI_ONBOARDING_PLAN.md",
        "blurb": "Hybrid provider design and the AI analysis pipeline behind AI-assisted onboarding. Linked from ARCHITECTURE.md; registered so the link resolves in the Docs tab.",
    },
    {
        "id": "git-and-cicd",
        "title": "Git onboarding and CI/CD",
        "category": "DevOps",
        "rel_path": "docs/GIT_AND_CICD.md",
        "blurb": "Onboard an application from a Git URL, and redeploy it on push: signed webhooks, branch filtering, run history, real HTTP verification, and rollback.",
    },
    {
        "id": "production-hardening",
        "title": "Production hardening — before a public domain",
        "category": "DevOps",
        "rel_path": "docs/PRODUCTION_HARDENING.md",
        "blurb": "What to change before exposing LEco on a real server: the Control API is unauthenticated by default, Traefik's API runs insecure, admin ports bind 0.0.0.0, and cloud-install performs no hardening.",
    },
    {
        "id": "mcp-server",
    ...
    {
        "id": "agent-route-map",
        "title": "START HERE — route map for agents",
        "category": "Project",
        "rel_path": "START_HERE.md",
        "blurb": "Entry point for AI agents and new operators: install, deploy an app, operate the stack, drive it over MCP, and install the Skill and plugin.",
    },
    {
