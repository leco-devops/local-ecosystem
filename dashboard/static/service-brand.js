...
(function (g) {
  const CONTROL_TARGET_BRAND = {
    ...
    "ai-paperclip-postgres": "paperclip-postgres",
  ...
  const SERVICE_NAME_BRAND = {
    ...
    n8n: "n8n",
    Paperclip: "paperclip",
    "PostgreSQL (Paperclip)": "paperclip-postgres",
    Ollama: "ollama",
  ...
  const ICONS = {
    ...
    paperclip: svg(
      "M16.5 6.5v8a4.5 4.5 0 0 1-9 0v-6a2.5 2.5 0 0 1 5 0v4a1 1 0 0 1-2 0V8.5h-2v3a3.5 3.5 0 0 0 7 0v-6a4.5 4.5 0 1 0-9 0v8h2v-8a2.5 2.5 0 0 1 5 0v6a4.5 4.5 0 0 1-9 0v-8h-2v8a6.5 6.5 0 0 0 13 0v-6a6.5 6.5 0 1 0-13 0z",
    ),
    "paperclip-postgres": svg(
