...
- **Brand palette:** Flat navy/teal/sky theme (`#022B3A`, `#1F7A8C`, `#BFDBF7`, `#E1E5F2`, `#FFFFFF`) — no gradients; light/dark logo variants; applied to GitHub Pages (`assets/css/leco.css`) and dashboard (`dashboard/static/dashboard.css`).
