...
- **File transfer (FTP/SFTP):** Compose **`file-transfer/`**; operator help **`docs/help/12-file-transfer.md`** (`help:file-transfer`); developer **`docs/help/dev-10-file-transfer.md`** (`help:dev-file-transfer`); canonical **`docs/FILE_TRANSFER.md`**; UI access registry slugs **`sftp`**, **`ftp`**, **`files`**; aligned modules in **`AGENTS.md`**.
